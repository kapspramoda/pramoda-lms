      ...
      <aside className={`w-64 bg-blue-900 text-white flex flex-col fixed inset-y-0 left-0 z-50 transform ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 md:static transition-transform duration-300 shadow-2xl`}>
        ...
        <nav className="flex-1 p-4 space-y-2 overflow-y-auto custom-scrollbar">
          ...
          {userClasses.includes('Paper') && (
            <>
              <a href="#" onClick={(e) => { e.preventDefault(); router.push('/paper-discussion'); }} className="flex items-center space-x-3 hover:bg-blue-800 px-4 py-3 rounded-lg transition">
          ...
          <a href="#" onClick={(e) => { e.preventDefault(); router.push('/dashboard/marks'); }} className="flex items-center space-x-3 bg-blue-800 px-4 py-3 rounded-lg transition shadow-inner border border-blue-800/30">
