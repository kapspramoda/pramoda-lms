  ...
  return (
    <div className={`min-h-screen font-sans scroll-smooth flex flex-col transition-colors duration-300 ${bgMain}`}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2 md:py-3 flex justify-between items-center">
          ...
          <nav className="hidden md:flex space-x-6 lg:space-x-8 items-center">
            ...
            <div className="flex items-center gap-2 border-l border-slate-300/30 pl-6 ml-2">
              ...
              <button onClick={() => router.push('/auth')} className="bg-gradient-to-r from-blue-600 to-blue-500 text-white px-6 py-2.5 rounded-full font-bold hover:from-blue-700 hover:to-blue-600 shadow-md hover:shadow-lg transition transform hover:-translate-y-0.5 ml-2">
                {t.nav.login}
              </button>
            </div>
          </nav>
          ...
          <div className="flex md:hidden items-center gap-2">
            ...
            <button onClick={() => router.push('/auth')} className="bg-blue-600 text-white px-4 py-2 rounded-full font-bold shadow-md text-xs">
              Login
            </button>
          </div>
        </div>
      ...
      <main className="flex-1">
        ...
        {/* Hero Section */}
        <section className="relative bg-slate-900 text-white overflow-hidden min-h-[600px] flex items-center justify-center">
          <div className="absolute inset-0 bg-gradient-to-b from-blue-950/80 to-slate-950/95 z-0"></div>
          <div className="absolute top-0 left-1/4 w-96 h-96 bg-blue-600 rounded-full mix-blend-multiply filter blur-[128px] opacity-40 animate-pulse"></div>
          <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-teal-500 rounded-full mix-blend-multiply filter blur-[128px] opacity-20"></div>
          
          <div className="relative z-10 max-w-5xl mx-auto px-4 py-16 md:py-20 text-center">
            <div className="flex justify-center mb-6">
              <img src="/logo.png" alt="Main Logo" className="w-40 h-40 md:w-56 md:h-56 lg:w-64 lg:h-64 object-contain drop-shadow-[0_10px_25px_rgba(37,99,235,0.5)]" />
            </div>

            <h1 className="text-4xl md:text-6xl lg:text-7xl font-black mb-4 leading-tight tracking-tight drop-shadow-lg">
              {t.hero.title1} <br className="hidden md:block" /> 
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-blue-300 to-teal-300">{t.hero.title2}</span>
            </h1>
            
            <p className="text-lg md:text-2xl mb-10 text-slate-300 font-medium leading-relaxed max-w-3xl mx-auto drop-shadow-md">
              {t.hero.desc1} <br className="md:hidden"/>
              <span className="font-bold text-white block mt-2 text-xl md:text-3xl">Pramoda Katipearachchi</span> 
              <span className="text-sm md:text-lg text-blue-300 block mb-3 font-medium">{t.hero.desc2}</span>
              <span className="text-sm md:text-base opacity-80">{t.hero.desc3}</span>
            </p>
            
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-6 mt-4">
              <a href="#schedule" className="bg-gradient-to-r from-blue-600 to-blue-500 text-white px-8 py-4 rounded-full font-bold text-lg hover:from-blue-700 hover:to-blue-600 shadow-xl shadow-blue-900/50 transition transform hover:-translate-y-1 w-full sm:w-auto text-center border border-blue-400/30">
                {t.hero.btn1}
              </a>
              <button onClick={() => router.push('/auth')} className="bg-white/10 backdrop-blur-md border border-white/20 text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-white/20 shadow-lg transition transform hover:-translate-y-1 w-full sm:w-auto">
                {t.hero.btn2}
              </button>
            </div>
          </div>
        ...
        {/* 🔴 Class Schedule Section (Mobile Grid) */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
            <div className={`md:col-span-3 p-8 md:p-12 rounded-3xl border ${isDarkMode ? 'bg-slate-900 border-slate-800' : 'bg-slate-50 border-slate-100'}`}>
              ...
              <div className="space-y-6">
                ...
                {/* WhatsApp Link with Official Logo */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm font-medium">
              <li><button onClick={() => router.push('/auth')} className="hover:text-blue-400 transition flex items-center gap-2"><span className="text-blue-600">▪</span> {t.nav.login}</button></li>
